...
$execute if score @s kits.raycast.step matches 0.. positioned ^ ^ ^$(inaccuracy) run function kits:generic/vfx/slash_scatter/slash_fwd {"inaccuracy":"$(inaccuracy)","vfx":"$(vfx)"}